...
public class WSWUBlastSoapBindingStub extends org.apache.axis.client.Stub implements uk.ac.ebi.webservices.WSWUBlast.WSWUBlast {
    ...
    public WSWUBlastSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
            ...
            cls = uk.ac.ebi.webservices.WSWUBlast.Data.class;
            ...
            cachedSerQNames.add(qName);
            cls = uk.ac.ebi.webservices.WSWUBlast.InputParams.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = uk.ac.ebi.webservices.WSWUBlast.WSFile[].class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(arraysf);
            cachedDeserFactories.add(arraydf);

            qName = new javax.xml.namespace.QName("http://www.ebi.ac.uk/WSWUBlast", "ArrayOf_xsd_string");
            cachedSerQNames.add(qName);
    ...
    public java.lang.String runWUBlast(uk.ac.ebi.webservices.WSWUBlast.InputParams params, uk.ac.ebi.webservices.WSWUBlast.Data[] content) throws java.rmi.RemoteException {
        ...
        org.apache.axis.client.Call _call = createCall();
        _call.addParameter(new javax.xml.namespace.QName("", "params"), new javax.xml.namespace.QName("http://www.ebi.ac.uk/WSWUBlast", "inputParams"), uk.ac.ebi.webservices.WSWUBlast.InputParams.class, javax.xml.rpc.ParameterMode.IN);
        _call.addParameter(new javax.xml.namespace.QName("", "content"), new javax.xml.namespace.QName("http://www.ebi.ac.uk/WSWUBlast", "WSArrayofData"), uk.ac.ebi.webservices.WSWUBlast.Data[].class, javax.xml.rpc.ParameterMode.IN);
    ...
    public java.lang.String[] getIds(java.lang.String jobid) throws java.rmi.RemoteException {
        ...
        org.apache.axis.client.Call _call = createCall();
        _call.addParameter(new javax.xml.namespace.QName("", "jobid"), new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, javax.xml.rpc.ParameterMode.IN);
        _call.setReturnType(new javax.xml.namespace.QName("http://www.ebi.ac.uk/WSWUBlast", "ArrayOf_xsd_string"), java.lang.String[].class);
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://www.ebi.ac.uk/WSWUBlast#getIds");
        _call.setOperationStyle("rpc");
        _call.setOperationName(new javax.xml.namespace.QName("http://www.ebi.ac.uk/WSWUBlast", "getIds"));
    ...
    public uk.ac.ebi.webservices.WSWUBlast.WSFile[] getResults(java.lang.String jobid) throws java.rmi.RemoteException {
        ...
        org.apache.axis.client.Call _call = createCall();
        _call.addParameter(new javax.xml.namespace.QName("", "jobid"), new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, javax.xml.rpc.ParameterMode.IN);
        _call.setReturnType(new javax.xml.namespace.QName("http://www.ebi.ac.uk/WSWUBlast", "WSArrayofFile"), uk.ac.ebi.webservices.WSWUBlast.WSFile[].class);
        _call.setUseSOAPAction(true);
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (uk.ac.ebi.webservices.WSWUBlast.WSFile[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (uk.ac.ebi.webservices.WSWUBlast.WSFile[]) org.apache.axis.utils.JavaUtils.convert(_resp, uk.ac.ebi.webservices.WSWUBlast.WSFile[].class);
            }
        }
    }
